...
In this section, we do beta regression analysis on the ReadingSkills data set. To visualise the regression, we split the results into dyslexic children and normal children
