...
Articles: [articles](articles/index.html){target="_blank"}
...
A lemonsqueezer [@smithson2006].

Beta regression [@ferrari2004].

Extended Beta Regression in R [@grun2012].

On Beta Regression Residuals [@espinheira2008].

A case for beta regression in natural sciences [@geissinger2022].

Nearly unbiased maximum likelihood estimateion [@cribari2002].
